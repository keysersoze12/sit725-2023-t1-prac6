...
describe("Add Two Numbers", function() {
    var url = "http://localhost:8080/exponents/3/5";
    ...
    it("returns the result equal to 243", function(done) {
      request(url, function(error, response, body) {
          body = JSON.parse(body)
          expect(body.result).to.equal(243);
          done()
        });
  });
  ...
  describe("Add Two strings", function() {
    var url = "http://localhost:8080/exponents/a/b";
